const { User, Restaurant, Review, Discussion, syncDatabase } = require('../models');
...
const seedDatabase = async () => {
  try {
    ...
    const restaurants = await Restaurant.bulkCreate([
      {
        name: 'The Top',
        description: 'Iconic Gainesville restaurant with a rooftop bar and diverse menu. Perfect for students and social gatherings.',
      ...
      {
        name: 'Satchels Pizza',
        description: 'Unique pizzeria with eclectic decor and delicious pies. Known for creative atmosphere and excellent pizza.',
      ...
      {
        name: 'Volta Coffee',
        description: 'Popular coffee shop perfect for studying or casual meetings. Great espresso and pastries.',
      ...
      },
      {
        ...
        description: 'Upscale sushi restaurant with fresh fish and creative rolls. Great for special occasions.',
      ...
      {
        name: 'Boca Fiesta',
        description: 'Authentic Mexican restaurant with great margaritas and festive atmosphere.',
      ...
      {
        name: 'Karma Cream',
        description: 'Vegan ice cream shop with unique flavors. Perfect for dessert or a sweet treat.',
    ...
    const reviews = await Review.bulkCreate([
      {
        ...
        content: 'The Top has an amazing atmosphere, especially on the rooftop. Food is solid and the drinks are good too. Perfect place to hang out with friends!',
        foodQuality: 4,
        serviceQuality: 5,
        atmosphereRating: 5,
        valueRating: 4,
      ...
      },
      {
        ...
        content: 'Volta is my go-to place for studying. Great coffee, quiet atmosphere, and fast wifi. The staff is friendly and lets you stay for hours.',
        foodQuality: 4,
        serviceQuality: 5,
        atmosphereRating: 5,
        valueRating: 5,
      ...
      },
      {
        ...
        content: 'Dragonfly never disappoints. Fresh fish, creative rolls, and beautiful presentation. A bit pricey but worth it for special occasions.',
        foodQuality: 5,
        serviceQuality: 4,
        atmosphereRating: 4,
        valueRating: 3,
      ...
      },
      {
        ...
        content: 'Satchels is a Gainesville gem! The pizza is incredible and the decor is so unique. Definitely a must-visit!',
        foodQuality: 5,
        serviceQuality: 5,
        atmosphereRating: 5,
        valueRating: 5,
    ...
    await Discussion.bulkCreate([
      ...
      },
      {
        ...
        content: 'Looking for someone to study with at Volta this week. I usually go in the mornings. Anyone interested?',
        category: 'meetup',
      ...
      },
      {
        ...
        content: 'Even if you\'re not vegan, Satchels vegan pizza is incredible. The cashew cheese is amazing!',
        category: 'tip',
